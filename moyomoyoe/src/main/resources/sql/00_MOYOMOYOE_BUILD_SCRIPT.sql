...
VALUES
    ...
    ('베이커리마당', '서울 마포구 마포대로 222', '디저트', 5, '갓 구운 빵과 디저트', '6677889900', NULL),
    ...
    ('피자스튜디오', '서울 서대문구 통일로 150', '레스토랑', 5, '나폴리 스타일의 화덕 피자 전문점', '1213141516', NULL),
...
INSERT INTO tbl_reservation (user_id_res, res_date, customer_num, schedule_id) VALUES (1, '2024-09-20', 2, 1),
                                                                                      ...
                                                                                      (1, '2024-09-24', 3, 2),
                                                                                      (3, '2024-09-27', 2, 1);
>>>>>>> 41d07d0e9ee935b20b1fcc558c324dba643e5231
