...
CREATE TABLE IF NOT EXISTS tbl_business_user
(
    id INT AUTO_INCREMENT COMMENT '사업자유저아이디',
    busy_no VARCHAR(10) NOT NULL COMMENT '사업자번호',
    store_id INT COMMENT '업체아이디',

    CONSTRAINT pk_business_user_id PRIMARY KEY (id),
    CONSTRAINT fk_business_user_id FOREIGN KEY (id) REFERENCES tbl_user (id)
) ENGINE=INNODB COMMENT '사업자유저';
...
(
    ...
    CONSTRAINT pk_comment_id PRIMARY KEY (comment_id,post_id),
...
(
    ...
    CONSTRAINT fk_business_store_user_id FOREIGN KEY (business_user_id) REFERENCES tbl_business_user (id)
...
(
    ...
    CONSTRAINT pk_schedule_id PRIMARY KEY (schedule_id,store_id),
...
(
    ...
    CONSTRAINT pk_res_id PRIMARY KEY (res_id,user_id),
    CONSTRAINT fk_user_reservation_id FOREIGN KEY (user_id) REFERENCES tbl_user (id),
    CONSTRAINT fk_schedule_id FOREIGN KEY (schedule_id) REFERENCES tbl_schedule (schedule_id),
    CONSTRAINT fk_store_reservation_id FOREIGN KEY (store_id) REFERENCES tbl_schedule (store_id)
...
INSERT INTO tbl_user (username, account, password, nickname, email, phone, user_role, image_id) VALUES ('user1', 'account1', 'password1', 'nick1', 'user1@example.com', '010-1234-5678', '일반회원', 1),
 ...
 INSERT INTO tbl_comment (post_id,comment_id, nickname, comment, comment_post_date, user_id) VALUES (1, 1, 'nick3', '첫 번째 게시물 정말 재미있어요!', '2024-09-06', 1),
																									(1, 2, 'nick3', '좋은 정보 감사합니다!', '2024-09-07', 1),
...
INSERT INTO tbl_reservation (user_id, res_date, customer_num, schedule_id, store_id) VALUES (1, '2024-09-20', 2, 1, 2),
																							(3, '2024-09-22', 4, 2, 2),
																							(1, '2024-09-24', 3, 2, 1),
																							(3, '2024-09-27', 2, 1, 1);
