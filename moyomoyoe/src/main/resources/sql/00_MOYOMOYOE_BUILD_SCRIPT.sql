...
VALUES ('user1', 'account1', 'password1', 'nick1', 'user1@example.com', '010-1234-5678', 'USER', 1, 1),
       ('user2', 'account2', 'password2', 'nick2', 'user2@example.com', '010-2345-6789', 'BUSINESS', 1, 2),
       ('user3', 'account3', 'password3', 'nick3', 'user3@example.com', '010-3456-7890', 'USER', 1, 3),
       ('user4', 'account4', 'password4', 'nick4', 'user4@example.com', '010-4567-8901', 'BUSINESS', 1, 4);
