...
//                .and();
        ...
        http.authorizeHttpRequests(auth -> {
            ...
            auth.requestMatchers("/member/auth/login", "/member/user/signup", "/member/auth/fail", "member/user/region", "member/user/checkAccount", "member/user/findId", "member/user/findPwd", "member/user/changePwd","/member/user/getInfo", "/main", "/").permitAll();
